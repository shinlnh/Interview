...
Tài liệu được chia theo từng chủ đề để GitHub render công thức ổn định và dễ tra cứu hơn.

## Nội dung

1. [3.1 Write or explain Adam optimizer pseudocode](./01-adam-optimizer.md)
2. [3.2 Masked Language Modeling — MLM](./02-masked-language-modeling.md)
3. [3.3 Matrix decomposition](./03-matrix-decomposition.md)
